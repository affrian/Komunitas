...
<div class="col-md-9">
    	<div class="center">
            ...
            <div id="header">
        		<form method="post" class="search" action="forum.php?page=forum_teman_cari">
        			<p>
        			Nama/Email Teman : <input name="search" id="search" class="textbox" type="text" required="required" />
        			<input name="cari" id="cari" class="button" value="Cari" type="submit" />
        			</p>
        		</form>
            </div>
            <hr>
