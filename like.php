...
<div class="container mt40">
    <section class="row">
<?php
	$sql=mysql_query("select*from tbl_artikel order by id_artikel desc limit 4");
        ...
        <article class="col-xs-12 col-sm-6 col-md-3">
            <div class="panel panel-default">
                <div class="panel-body">
                    <a href="galeri/<?php echo $data['cover'];?>" title="Nature Portfolio" class="zoom" data-title="Amazing Nature" data-footer="The beauty of nature" data-type="image" data-toggle="lightbox">
                        <img src="galeri/<?php echo $data['cover'];?>" alt="Nature Portfolio" />
                        <span class="overlay"><i class="glyphicon glyphicon-fullscreen"></i></span>
                    </a>
                </div>
                <div class="panel-footer">
                    <h4><a href="#" title="Nature Portfolio"><?php echo $data['judul_artikel'];?></a></h4>
