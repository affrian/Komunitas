...
<?php
	$sql=mysql_query("select*from tbl_pesan where id_member='$id_member' order by id_pesan desc");
?>    	
    <div class="wrapper">
...
<th style="width: 80px">Option</th>
			   ...
			   ?>   
                        ...
                        <td><?php echo $no;?></td>
                        <?php
							$query=mysql_query("select*from tbl_member where id_member='$data[id_tujuan]'");
							$kepada=$data['id_tujuan'];
						?>
                          <td class="mailbox-name">
						  <a href="forum.php?page=forum_profil_teman&id_member=<?php echo $kepada; ?>">
						  <?php echo $data['kepada'];?>
                          </a>
                          </td>
                          <td class="mailbox-subject"><b><?php echo $data['judul']; ?></b> -
